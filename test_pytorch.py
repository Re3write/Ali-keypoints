...
def main(args):
    ...
    checkpoint_file = os.path.join('model', 'checkpoint', 'epoch10checkpoint.pth.tar')
    ...
    Evaluator = FaiKeypoint2018Evaluator(userAnswerFile=os.path.join(result_path, 'result.csv'),
